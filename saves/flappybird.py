...
#counter = 0
try:
    visitedMap = pickle.load( open( "vMap.p", "rb" ) )
except:
        visitedMap = {}

try:
    rewardMap  = pickle.load( open( "rewardMap.p", "rb" ) )
except:
        rewardMap = {}
...
"""
       ...
       # print(WIN_HEIGHT)
            ...
            if(  int(time.time()) % 120 == 0):
                pickle.dump( dSpaceArray, open( "save.p", "wb" ) )
                pickle.dump( visitedMap, open( "vMap.p", "wb" ) )
                pickle.dump( rewardMap, open( "rewardMap.p", "wb" ) )
                print("-----------------------------pickle---------------------------")
